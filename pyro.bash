...
## get things from apt: ##
# first batch
DEBIAN_FRONTEND=noninteractive apt install -y build-essential default-jre dirmngr gnupg apt-transport-https ca-certificates software-properties-common cmake tzdata
# second batch
